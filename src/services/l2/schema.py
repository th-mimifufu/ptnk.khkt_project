...
from src.services.constants1 import TinhTP, SubjectGroup, CCTA, CEFRLevel, JLPTLevel, NhomNganh
...
class UserInputL2(BaseModel):
    ...
    to_hop_mon: SubjectGroup = Field(..., description="Tổ hợp môn (vd: D01, A00, VNUHCM, ...)")
